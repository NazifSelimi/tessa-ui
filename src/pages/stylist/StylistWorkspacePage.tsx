...
export default function StylistWorkspacePage() {
  ...
  return <div className="stylist-workspace">
    <section className="stylist-workspace__hero">
      ...
      <Link to="/stylist/quick-order"><Button type="primary" size="large" icon={<ThunderboltOutlined />}>{t('stylistWorkspace.quickOrderAction')}</Button></Link>
    </section>
    ...
    <Row gutter={[16, 16]}>
      <Col xs={24} md={10}><Card className="stylist-workspace__restock"><ThunderboltOutlined /><Title level={3}>{t('stylistWorkspace.quickOrderTitle')}</Title><Text>{t('stylistWorkspace.quickOrderCopy')}</Text><Link to="/stylist/quick-order"><Button type="primary" size="large">{t('stylistWorkspace.quickOrderAction')}</Button></Link></Card></Col>
